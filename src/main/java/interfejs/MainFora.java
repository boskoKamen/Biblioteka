 ...
 * @author Krstic
 */
public class MainFora extends javax.swing.JFrame {

    /**
     * Creates new form MainFora
     */
    public MainFora() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        sidePanel.setBackground(new java.awt.Color(240, 240, 200));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MainFora.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
